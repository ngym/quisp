...
def main() -> int:
  ...
  cases = [
      ...
      ("advanced:detection two-target", {"kind": "detection", "targets": [{"node_id": 1, "qnic_index": 0, "qnic_type": 0, "qubit_index": 1}, {"node_id": 1, "qnic_index": 0, "qnic_type": 0, "qubit_index": 2}]}, True, ["model:auto", "measured_plus", "outcome", "branch_probability"]),

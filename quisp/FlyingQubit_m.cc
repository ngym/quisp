...
void doParsimPacking(omnetpp::cCommBuffer *buffer, const std::list<T, A> &l) {
  ...
  for (typename std::list<T, A>::const_iterator it = l.begin(); it != l.end(); ++it) doParsimPacking(buffer, (T &)*it);
}
...
void doParsimPacking(omnetpp::cCommBuffer *buffer, const std::set<T, Tr, A> &s) {
  ...
  for (typename std::set<T, Tr, A>::const_iterator it = s.begin(); it != s.end(); ++it) doParsimPacking(buffer, *it);
}
...
Register_Class(FlyingQubit)
    ...
    FlyingQubit::FlyingQubit(const char *name, short kind)
    : ::omnetpp::cMessage(name, kind) {}

FlyingQubit::FlyingQubit(const FlyingQubit &other) : ::omnetpp::cMessage(other) { copy(other); }
...
const char *FlyingQubit::getMessage_type() const { return this->message_type.c_str(); }

void FlyingQubit::setMessage_type(const char *message_type) { this->message_type = message_type; }

const ::IQubit *FlyingQubit::getQubitRef() const { return this->qubitRef; }

void FlyingQubit::setQubitRef(::IQubit *qubitRef) { this->qubitRef = qubitRef; }

bool FlyingQubit::isFirst() const { return this->isFirst_; }

void FlyingQubit::setFirst(bool isFirst) { this->isFirst_ = isFirst; }

bool FlyingQubit::isLast() const { return this->isLast_; }

void FlyingQubit::setLast(bool isLast) { this->isLast_ = isLast; }
...
Register_ClassDescriptor(FlyingQubitDescriptor)
    ...
    : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(quisp::messages::FlyingQubit)), "omnetpp::cMessage") {
  propertyNames = nullptr;
}

FlyingQubitDescriptor::~FlyingQubitDescriptor() { delete[] propertyNames; }

bool FlyingQubitDescriptor::doesSupport(omnetpp::cObject *obj) const { return dynamic_cast<FlyingQubit *>(obj) != nullptr; }
...
unsigned int FlyingQubitDescriptor::getFieldTypeFlags(int field) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldTypeFlags(field);
...
const char *FlyingQubitDescriptor::getFieldTypeString(int field) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldTypeString(field);
    field -= base->getFieldCount();
  }
...
const char **FlyingQubitDescriptor::getFieldPropertyNames(int field) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldPropertyNames(field);
    field -= base->getFieldCount();
  }
  switch (field) {
    case FIELD_isFirst: {
...
const char *FlyingQubitDescriptor::getFieldProperty(int field, const char *propertyName) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldProperty(field, propertyName);
    field -= base->getFieldCount();
  }
  switch (field) {
    case FIELD_isFirst:
...
int FlyingQubitDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldArraySize(object, field);
    field -= base->getFieldCount();
  }
  FlyingQubit *pp = omnetpp::fromAnyPtr<FlyingQubit>(object);
  (void)pp;
  switch (field) {
    default:
      return 0;
...
void FlyingQubitDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const {
  ...
  switch (field) {
    default:
      throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'FlyingQubit'", field);
  }
}
...
const char *FlyingQubitDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldDynamicTypeString(object, field, i);
    field -= base->getFieldCount();
  }
  FlyingQubit *pp = omnetpp::fromAnyPtr<FlyingQubit>(object);
  (void)pp;
  switch (field) {
    case FIELD_qubitRef: {
      const ::IQubit *value = pp->getQubitRef();
      return omnetpp::opp_typename(typeid(*value));
    }
    default:
      return nullptr;
  }
...
std::string FlyingQubitDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldValueAsString(object, field, i);
    field -= base->getFieldCount();
  }
  FlyingQubit *pp = omnetpp::fromAnyPtr<FlyingQubit>(object);
  (void)pp;
  switch (field) {
    case FIELD_message_type:
      return oppstring2string(pp->getMessage_type());
    case FIELD_qubitRef:
      return "";
    case FIELD_isFirst:
      return bool2string(pp->isFirst());
    case FIELD_isLast:
      return bool2string(pp->isLast());
    default:
      return "";
  }
}
...
void FlyingQubitDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const {
  ...
  switch (field) {
    case FIELD_message_type:
      pp->setMessage_type((value));
      break;
    case FIELD_isFirst:
      pp->setFirst(string2bool(value));
      break;
    case FIELD_isLast:
      pp->setLast(string2bool(value));
      break;
    default:
      throw omnetpp::cRuntimeError("Cannot set field %d of class 'FlyingQubit'", field);
  }
}
...
omnetpp::cValue FlyingQubitDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldValue(object, field, i);
    field -= base->getFieldCount();
  }
  FlyingQubit *pp = omnetpp::fromAnyPtr<FlyingQubit>(object);
  (void)pp;
  switch (field) {
    case FIELD_message_type:
      return pp->getMessage_type();
    case FIELD_qubitRef:
      return omnetpp::toAnyPtr(pp->getQubitRef());
      break;
    case FIELD_isFirst:
      return pp->isFirst();
    case FIELD_isLast:
      return pp->isLast();
    default:
      throw omnetpp::cRuntimeError("Cannot return field %d of class 'FlyingQubit' as cValue -- field index out of range?", field);
  }
}
...
void FlyingQubitDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue &value) const {
  ...
  switch (field) {
    case FIELD_message_type:
      pp->setMessage_type(value.stringValue());
      break;
    case FIELD_qubitRef:
      pp->setQubitRef(omnetpp::fromAnyPtr<::IQubit>(value.pointerValue()));
      break;
    case FIELD_isFirst:
      pp->setFirst(value.boolValue());
      break;
    case FIELD_isLast:
      pp->setLast(value.boolValue());
      break;
    default:
      throw omnetpp::cRuntimeError("Cannot set field %d of class 'FlyingQubit'", field);
  }
...
const char *FlyingQubitDescriptor::getFieldStructName(int field) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldStructName(field);
    field -= base->getFieldCount();
  }
  switch (field) {
    default:
...
omnetpp::any_ptr FlyingQubitDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const {
  omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
  if (base) {
    if (field < base->getFieldCount()) return base->getFieldStructValuePointer(object, field, i);
    field -= base->getFieldCount();
  }
  FlyingQubit *pp = omnetpp::fromAnyPtr<FlyingQubit>(object);
  (void)pp;
...
void FlyingQubitDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const {
  ...
  switch (field) {
    case FIELD_qubitRef:
      pp->setQubitRef(omnetpp::fromAnyPtr<::IQubit>(ptr));
      break;
    default:
      throw omnetpp::cRuntimeError("Cannot set field %d of class 'FlyingQubit'", field);
  }

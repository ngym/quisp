...
/**
 * \brief handle FlyingQubit generated by StationaryQubit itself
 *
...
void EntangledPhotonPairSource::emitPhotons() {
  ...
  auto *left_photon = new FlyingQubit("LeftPhoton");
  auto *right_photon = new FlyingQubit("RightPhoton");
  auto *left_photon_ref = backend->getFlyingQubit();
  auto *right_photon_ref = backend->getFlyingQubit();

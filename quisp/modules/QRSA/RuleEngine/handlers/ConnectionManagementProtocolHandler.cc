...
core::events::ProtocolType ConnectionManagementProtocolHandler::protocolSpec() const { return EventProtocol::ConnectionManagement; }
...
void ConnectionManagementProtocolHandler::registerHandlers(RuleEngine &engine) {
  ...
  register_handler(EventType::RULESET_FORWARDING, EventProtocol::ConnectionManagement, [&engine](const core::events::RuleEvent &event) {
  ...
  register_handler(EventType::LINK_TOMOGRAPHY_RULESET, EventProtocol::LinkTomography, [&engine](const core::events::RuleEvent &event) {
  ...
  register_handler(EventType::RULESET_FORWARDING_APPLICATION, EventProtocol::ConnectionManagement, [&engine](const core::events::RuleEvent &event) {
